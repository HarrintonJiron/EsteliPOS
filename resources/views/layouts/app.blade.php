            ...
            <nav class="flex-1 space-y-0.5 overflow-y-auto overflow-x-hidden px-3 py-3">
                @php
                    $navSections = [
                        ...
                        [
                            ...
                            'items' => [
                                ...
                                ['route' => 'arqueo.history', 'label' => 'Arqueos de caja', 'icon' => 'M9 14l2 2 4-4m5-3a9 9 0 11-6.219-8.56M20 4v5h-5', 'match' => 'arqueo.*'],
                                ...
                                ['route' => 'joyeria.index', 'label' => 'Joyería', 'icon' => 'M12 3l4 4-4 10L8 7l4-4zm-4 4H4l8 14 8-14h-4', 'match' => 'joyeria.*'],
                                ['route' => 'operaciones-clientes.index', 'label' => 'Apartados y envíos', 'icon' => 'M3 7h11v10H3V7zm11 3h4l3 3v4h-7v-7zM7 20a2 2 0 100-4 2 2 0 000 4zm10 0a2 2 0 100-4 2 2 0 000 4z', 'match' => ['operaciones-clientes.*', 'apartados.*', 'envios.*']],
                                ...
                                ['route' => 'gastos.index', 'label' => 'Gastos', 'icon' => 'M9 14l6-6m-5.5.5h.01m5 5h.01M5 4h14a1 1 0 011 1v14a1 1 0 01-1 1H5a1 1 0 01-1-1V5a1 1 0 011-1z', 'match' => 'gastos.*'],
                                ['route' => 'inventario.index', 'label' => 'Inventario', 'icon' => 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4', 'match' => ['inventario.index', 'inventario.dashboard', 'inventario.warehouses.*', 'inventario.transfers.*', 'inventario.price-lists.*', 'inventario.units.*', 'inventario.quick', 'inventario.create', 'inventario.edit', 'inventario.show', 'inventario.bulk']],
                            ],
                        ],
                        [
                            'label' => 'Gestión',
                    ...
                    $moduleByRoute = [
                        ...
                        'arqueo.history' => 'ventas',
                        'proformas.index' => 'proformas', 'reparaciones.index' => 'reparaciones', 'joyeria.index' => 'joyeria',
                        'operaciones-clientes.index' => 'operaciones_clientes',
