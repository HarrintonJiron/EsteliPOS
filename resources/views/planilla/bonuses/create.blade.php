            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="type" required
                        ...
                        <option value="performance" @selected(old('type') === 'performance')>Desempeño</option>
                        <option value="sales" @selected(old('type') === 'sales')>Ventas</option>
                        <option value="attendance" @selected(old('type') === 'attendance')>Asistencia</option>
                        <option value="christmas" @selected(old('type') === 'christmas')>Navideño</option>
                        <option value="productivity" @selected(old('type') === 'productivity')>Productividad</option>
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="reason" rows="3"
                        ...
                        placeholder="Describa el motivo del bono (opcional)">{{ old('reason') }}</textarea>
                </div>
            </div>
