<div id="posQuantityTools" class="pos-quantity-tools hidden">
    <div id="selectedItemBar" class="pos-pad-item">
        <div class="pos-pad-item__meta">
            <span class="pos-pad-item__label">Editando cantidad</span>
        ...
        <div class="pos-pad-item__qty" role="group" aria-label="Cantidad">
            ...
            <input id="selectedItemQty" class="pos-pad-item__value" type="text" inputmode="decimal"
                autocomplete="off" aria-label="Cantidad del producto" value="1">
            <button type="button" class="pos-key pos-key--step" onclick="padAdjust(1)" aria-label="Sumar cantidad">+</button>
            <button type="button" class="pos-pad-item__close" onclick="hideQuantityEditor()" aria-label="Ocultar editor de cantidad" title="Ocultar cantidad y teclado">✕</button>
        </div>
    </div>

    <div id="posNumpad" class="pos-pad hidden">
        <button type="button" id="posPadToggle" class="pos-pad__toggle" onclick="togglePosPad()" aria-expanded="false" aria-controls="posPadKeys">
            ...
            <span class="pos-pad__toggle-copy">
                <strong id="posPadToggleLabel">Mostrar teclado</strong>
                <small>Teclado físico o digital</small>
            </span>
