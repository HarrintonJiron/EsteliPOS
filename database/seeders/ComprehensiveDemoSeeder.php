    ...
    private function seedRepairs(array $clients, array $products): void
    {
        ...
        for ($i = 1; $i <= 10; $i++) {
            ...
            $repair = RepairOrder::create([
                ...
                'include_warranty_policy' => true,
                'warranty_days' => 30,
                'warranty_policy' => 'La garantía cubre únicamente el servicio realizado y los repuestos instalados. No cubre golpes, humedad, daños eléctricos, manipulación por terceros ni fallas distintas a la reportada. Para solicitar garantía es obligatorio presentar este ticket.',
                'status' => $status,
